...
public class ArchTradespaceExplorer {
    ...
    public void search_NSGA2() {
        System.out.println("Starting NSGA-II ...");
        ...
        while (!converged) {
            ...
            System.out.println("Evaluating population of size " + current_population.size());
            ...
            System.out.println("Generation " + nits + " done in " + String.valueOf((t1-t0)/60000.0) + ". Approx time remaining " + String.valueOf((t1-t0)/60000.0*(term_crit.getMAX_ITS()-nits-1)));
        }
    }
    ...
    public void selection_NSGA2() {
        System.out.println("Selecting architectures for next generation ...");
    ...
    public void setCurrent_population(ArrayList<Architecture> pop){
