...
public class ResultManager {
    ...
    public void saveResultCollection( ResultCollection c )
    {
        ...
        try {
            ...
            os.close();
            file.close();
            System.out.println("Saved results collection to: " + c.getFilePath());
        } catch (Exception e) {
    ...
    public ResultCollection loadResultCollection( String stamp )
    {
        ...
        String filePath = Params.path_save_results + File.pathSeparator + stamp;
        try {
    ...
    public void loadAllCollections( String path )
    {
        ...
        path = Params.path + File.pathSeparator + path;
